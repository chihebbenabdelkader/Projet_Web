...
if (isset($_POST['id']) and isset($_POST['nom']) and isset($_POST['description']) and isset($_POST['cat']) and isset($_POST['prix']) and isset($_POST['quantite']) )
{
  $targetDir = "uploads/";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Ajouter Produit</h4>
                                    ...
                                    <div class="card-body">
                                        <form  onsubmit="return validateForm()" name="myForm" method="POST" >
                                            <div class="row">
                                                <div class="col-sm-6">
                                                <div class="mb-3">
                                                        <input  name="id" type="text" class="form-control" hidden>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input  name="quantite" type="number" class="form-control" >
                                                    </div>
                                            ...
                                            <input  name="image" type="file" class="file" data-browse-on-zone-click="true">
                                            </div>
                                            <br>
