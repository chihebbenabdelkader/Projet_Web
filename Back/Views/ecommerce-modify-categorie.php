...
<head>
        ...
        <meta charset="utf-8" />
        <title>Add Product | Dason - Admin & Dashboard Template</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg" >
                                    <img src="assets/images/logo.png" alt=""  width="72"  class="center"> 
                                </span>
                            </a>
                        </div>
...
*                                   <li><a href="ecommerce-categories.php" key="t-products"> Categories</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Modifier Categorie</h4>
  ...
  $catC=new categorieC();
  if (isset($_GET['id'])){
    $result=$catC->recupererCategorie($_GET['id']);
...
?>
                                        <form action="" method="POST" >
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label >Id de categorie</label>
                                                        <input class="form-control" type="number" name="id" value="<?PHP echo $_GET['id'];?>" readonly="readonly">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="nom">Nom de categorie</label>
                                                        <input  type="text" name="nom" value="<?PHP echo $nom ?>" class="form-control" required pattern="[a-zA-Z ]{3,15}" placeholder="Entrer le nom de categorie" >
                                                    </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="submit" name="modifier" value="Update" class="btn btn-primary waves-effect waves-light">Enregistrer</button>
                                                <button type="button" class="btn btn-secondary waves-effect waves-light">Annuler</button>
                                            </div>
    ...
    if (isset($_POST['modifier'])){
        ...
        $catC->modifierCategorie($cat,$_POST['id']);
        echo $_POST['id'];
        echo ("<script> window.location.replace(\"ecommerce-categories.php\")</script>");
    }
    ?>
