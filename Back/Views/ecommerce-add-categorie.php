                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="assets/images/logo.png" alt=""  width="70"> <span class="logo-txt"></span>
                                </span>
                            </a>
                            <style>
                                .center {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Ajouter Categorie</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input  name="nom" id="nom" type="text" class="form-control" required pattern="[a-zA-Z ]{3,15}" placeholder="Entrer le nom de categorie" >
                                                    </div>
