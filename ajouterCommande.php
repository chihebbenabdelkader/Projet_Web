      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-3 bread"style="color: white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Produit</h1>
          </div>
        </div>
      </div>
    </section>
            ...
            <table border="1" align="center" style="color: white">
                ...
                <tr>
                    ...
                    <td><input type="text" name="prenom" id="prenom" maxlength="20"></td>
				        ...
				        <tr>
                    <td>
                        <label for="num_telephone">num_telephon:
                        </label>
                    </td>
                    <td><input type="number" name="num_telephone" id="num_telephone" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="region" id="region" maxlength="20">
                    </td>
                </tr>   
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="ville" id="ville" maxlength="20">
                    </td>
                </tr>                           
                <tr>
                    <td></td>
