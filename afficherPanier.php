...
$panierc=new panierc();
$panierS=$panierc->afficherlist_panier($id_utilisateur);
...
<!-- Mirrored from dmitryvolkov.me/demo/gogame1.3/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Apr 2022 11:23:16 GMT -->
<head>
	<meta charset="utf-8">
           ...
           <div class="cart-view-table">
             <form action="">
               <div class="table-responsive">
                  <table class="table" border="3" align="center"  style="color: white">
                    <thead>
                      <tr>
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <th>Product</th>
                        <th>&nbsp;&nbsp;Price</th>
                      ...
                      <tr>
                         <td>
                              <h1 style="color:#B00000;"><font size="5"><input type="hidden" value="<?PHP echo $row['id_panier']; ?>" name="id_panier"></font></h1>
							  <button class="remove"><fa class="fa fa-close"></fa></button>
								</td>

                          <td> 
                             <input type="hidden" value="<?PHP echo $row['id_panier']; ?>" name="id_panier">
                             <a class="aa-product-img" href="#"><img src="images/img1.png" alt="image" height="200" width="200"></a>
						 </td> 
                              <td><a class="aa-cart-title"><?php echo $row['nom_produit']?></a>
					                </td>
                         <td><?php echo $row['prix']?></td>
						 <form action="editQuantity.php" method="POST">
                            <input type="hidden" name="id_panier" value="<?php echo $row['id_panier']  ?>">
                            <td><input class="aa-cart-quantity" name="nbr" type="number" data-id="<?php echo $row['id_panier']  ?>"  value="<?php echo $row['nbr']; ?>" min='1' max='5'></td>
                          </form>
                          <td><?php echo $somme ?></td>
                      
						 <td>
                            <a href="supprimerPanier.php?id_panier=<?php echo $row['id_panier']; ?>">&nbsp;&nbsp;&nbsp;
...
<button><a href="ajouterCommande.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Commander&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></button><br>
<br>
<br>
<br>
<br>
