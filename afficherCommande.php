...
<br>
    ...
    ?>
            ...
            <td><?php echo $commande['num_telephone'];?></td> 
            <td><?php echo $commande['email'];?></td>    
            <td><?php echo $commande['adresse'];?></td>  
            <td><?php echo $commande['region'];?></td>  
            ...
            <td>
                        <a href="supprimerCommande.php?id_commande=<?php echo $commande['id_commande']; ?>">&nbsp;&nbsp;&nbsp;
...
<button><a href="payement.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Continuer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></button><br>
<br>
<br>
<br>
<br>
