				...
				<div class="col-12">
					<div class="section__wrap">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb__item breadcrumb__item--active">Porduits</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-md-4 col-xl-3">
							<div class="card card--catalog">
								<a href="details.php?details=<?= $P['id']; ?>" class="card__cover">
								...
								<div class="card__title">
									<h3><a href="details.php?details=<?= $P['id']; ?>"> <?PHP echo $P['nom']; ?></a></h3>
									<span> <?PHP echo $P['prix']; ?> Dinars</span>
								</div>

								<div class="card__actions">
									<button class="card__buy" type="button">Acheter</button>
