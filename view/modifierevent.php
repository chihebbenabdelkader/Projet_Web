<?php
    ...
    { 
        echo $_POST['idEvent'] ;
            $evenement = new Evenement($_POST['idEvent'] , $_POST['nomEvent'] ,$_POST['typeEvent'], $_POST['dateD']  ,$_POST['dateF']);
            $eventC->modifier($evenement);
...
<form action="" method="POST">
            <table border="1" align="center">
				...
				<tr>
                    ...
                    <td><input type="text" value="<?php echo $a['nomEvent'];?>" name="nomEvent" id="nomEvent" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="typeEvent" id="typeEvent " value="<?php echo $a['typeEvent'];?>"  ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="date" name="dateD" id="dateD" maxlength="20" value="<?php echo $a['dateD'];?>"  ></td>
                ...
                <tr>
                    ...
                    <td><input type="date" name="dateF" id="dateF" maxlength="20" value="<?php echo $a['dateF'];?>"  ></td>
                </tr>
