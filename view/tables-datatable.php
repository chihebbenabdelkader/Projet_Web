...
include '../eventC/participantC.php';
   ...
   if (isset($_GET['tri'])) {
    $listeParticipants= $participantC->affichertri();
}
...
"></script>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <br>
                                     <br>
                                     <button class="bb"><a href="ajouterevent.php" class="imprimer"> ajouter </a></button>
                                     <br>
                                     <button class="bb"><a href="imprimerevenement.php" class="imprimer">imprimer </a></button>
                                     <br>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">table participants</h4>
                                    ...
                                    <button  class="bb"><a href="tables-datatable.php?tri=1"> trier  </a></button>
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            <thead>
                                            <tr>
                                               <th>idParticipant</th>
                                                <th>nomParticipant</th>
                                                <th>prenomParticipant</th>
                                                <th>ageParticipant</th>
                                            ...
                                            <tr>
				                         <td><?php echo $participant['idParticipant']; ?></td>
				                         <td><?php echo $participant['nomParticipant']; ?></td>
				                       <td><?php echo $participant['prenomParticipant']; ?></td>
				                            <td><?php echo $participant['ageParticipant']; ?></td>
				                    <td><?php echo $participant['emailParticipant']; ?></td>
                                    <td><?php echo $participant['dateInscri']; ?></td>
                                    <td><button class="supp_bt"><a style=" color: black"  href="supprimerparticipant.php?idParticipant=<?php echo $participant['idParticipant']; ?></a>">supprimer</button></td>
                                    <td><button class="modif_bt"><a style=" color: black"  href="modifierparticipant.php?idParticipant=<?php echo $participant['idParticipant'] ; ?>">modifier</button></a></td>        
