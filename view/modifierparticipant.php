<?php
    ...
    if (isset($_POST['idParticipant'] ) && isset($_POST['nomParticipant'] ) && isset($_POST['prenomParticipant'] ) && isset($_POST['ageParticipant'] ) && isset($_POST['emailParticipant'] ) && isset($_POST['dateInscri'] ) ) 
    { 
        echo $_POST['idParticipant'] ;
            $participant = new Participant($_POST['idParticipant'] , $_POST['nomParticipant'] ,$_POST['prenomParticipant'], $_POST['ageParticipant']  ,$_POST['emailParticipant']  ,$_POST['dateInscri']);
            $participantC->modifierparticiper($participant);
            header('Location:tables-datatable.php');
    }else
    {
        $a = $participantC->getparticipantbyID($_GET['idParticipant']) ;
...
<!-- Mirrored from themesdesign.in/dason-django/layouts/default/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Apr 2022 20:28:05 GMT -->
<head>
        
        <meta charset="utf-8" />
        <title>DataTables | Dason - Admin & Dashboard Template</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 style= "color:blue" >modifier votre evenement</h2>
                                    ...
                                    <br>
                                     <br>
                                    <!--<a  style=" color: blue" href="ajouterevent.php"> Ajouter article </a>-->
                                    <div class="card-body">
...
<body id="pid-top">
    <a href= "tables-datatable.php">retour a la page principale</a>
<form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    ...
                    <td><input type="number" name="idParticipant" id="idEvent" maxlength="20" value="<?php echo $a['idParticipant'];?>"  readonly></td>
                </tr>
				<tr>
                    <td>
                        <label for="nomParticipant">nom participant:
                        </label>
                    </td>
                    <td><input type="text" value="<?php echo $a['nomParticipant'];?>" name="nomParticipant" id="nomParticipant" ></td>
                </tr>
                <tr>
                    <td>
                        <label for="prenomParticipant">prenom participant:
                        </label>
                    </td>
                    <td><input type="text" name="prenomParticipant" id="prenomParticipant " value="<?php echo $a['prenomParticipant'];?>"  ></td>
                </tr>
                <tr>
                    <td>
                        <label for="ageParticipant">age participant:
                        </label>
                    </td>
                    <td><input type="number" name="ageParticipant" id="ageParticipant" maxlength="20" value="<?php echo $a['ageParticipant'];?>"  ></td>
                ...
                <tr>
                    <td>
                        <label for="emailParticipant">email participant:
                        </label>
                    </td>
                    <td><input type="email" name="emailParticipant" id="emailParticipant" maxlength="20" value="<?php echo $a['emailParticipant'];?>"  ></td>
                ...
                <tr>
                    <td>
                        <label for="dateInscri">date Inscri:
                        </label>
                    </td>
                    <td><input type="date" name="dateInscri" id="dateInscri" maxlength="20" value="<?php echo $a['dateInscri'];?>"  ></td>
                </tr>
...
<!-- Mirrored from themesdesign.in/dason-django/layouts/default/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Apr 2022 20:28:11 GMT -->
</html>