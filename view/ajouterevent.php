...
require_once     '../eventC/eventC.php';
   ...
   // require_once '../model/categorie.php';
    ...
    if  (isset($_POST['idEvent'] ) && isset($_POST['nomEvent'] ) && isset($_POST['typeEvent'] ) && isset($_POST['dateD']) && isset($_POST['dateF']) )
    {if(!empty($_POST['idEvent']) && !empty($_POST['nomEvent']) && !empty($_POST['typeEvent']) && !empty($_POST['dateD'])  &&  !empty($_POST['dateF'])             )
       ...
       /* { $targetDir = "uploads/";
          ...
          $produit=new Produit($_POST['id'],$_POST['nom'],$_POST['description'],$_POST['image'],$_POST['cat'],$_POST['prix'],$_POST['quantite']);
            ...
            $event = new Evenement($_POST['idEvent'] , $_POST['nomEvent'] ,$_POST['typeEvent'], $_POST['dateD'] ,$_POST['dateF']);
...
<head>
<script  src="assets/js/jac.js"></script>
        <meta charset="utf-8" />
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 style= " color:black" >ajouter un evenement</h2>
...
<body id="pid-top">
<link rel="stylesheet" href="assets/css/contr.css" type="text/css" />
...
<form  action="" method="POST" id="vrf">
      <table border="2" align="center">
            <tr>
                <td>
                    <label for="idEvent">id event:
                    </label>
                </td>
                 <td>
                    <input type="TEXT" name="idEvent" id="idEvent" required>
            ...
            <tr>
               <td>
                    <label for="typeEvent">type event  :
                    </label>
               </td>
                 <td>
            ...
            <tr>
               <td>
                    <label for="dateD">date debut :
                    </label>
                </td>
                <td><input type="date" name="dateD" id="dateD" required>
          </td>
           
            </tr>
            <tr>
               <td>
                    <label for="dateF">date final     :
                    </label>
               </td>
                <td><input type="date" name="dateF" id="dateF" required>
          </td>
            ...
            <tr>
                <td>
                    ...
                    </div><p style="color: red;" id="erreur" ></p>                      
                  <script  src="assets/js/jac.js"></script>
